...
public class AdsListModel implements Serializable {

    private final String TAG = "AdsListModel";
    ...
    public boolean toObject(String jsonObjectString){
        try{
            ...
            List<AdsModel> list = new ArrayList<AdsModel>();
            for (int i=0;i<array.length();i++){
                JSONObject jsonObject = array.getJSONObject(i);
                AdsModel keyValueModel = new AdsModel();
