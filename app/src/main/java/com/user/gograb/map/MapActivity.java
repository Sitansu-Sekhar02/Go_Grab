...
import com.user.gograb.services.model.UserAddressModel;
import com.user.gograb.util.PermissionUtils;
import com.user.gograb.widget.TouchableWrapper;
        ...
        public void onSuccess(Object object) {
            if (object instanceof FetchPlaceResponse) {
                ...
                if (fetchPlaceResponse != null) {
                    ...
                    mAddress.setLatitude(String.valueOf(place.getLatLng().latitude));
                    mAddress.setLongitude(String.valueOf(place.getLatLng().longitude));
...
/*    private ResultCallback<PlaceBuffer>
 ...
 /*   public static Intent newInstance(Context context, VendorDetailModel vendorDetailModel, AddressModel addressModel, GlobalVariables.LOCATION_TYPE locationType) {
    ...
    public void setLatLng(double latitude, double longitude) {
        ...
        mAddress.setLatitude(String.valueOf(latitude));
        mAddress.setLongitude(String.valueOf(longitude));
    }
    ...
    private void setResult(boolean isSuccess) {
       ...
       // userAddressModel.setAddress1(mAddress.getAddress());
