...
public class OfferListModel implements Serializable {
    ...
    private final String TAG = "OfferListModel";

    private final String RESPONSE = "offer_list";
    ...
    public void setOfferModels(List<OfferModel> bannerList) {
        this.offerModels = bannerList;
    }
    ...
    public boolean toObject(String jsonObjectString){
        try{
            ...
            List<OfferModel> list = new ArrayList<OfferModel>();
    ...
    public String toString(){
        ...
        try{
            ...
            List<OfferModel> list = this.offerModels;
