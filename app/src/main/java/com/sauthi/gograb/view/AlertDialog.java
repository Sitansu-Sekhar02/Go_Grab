...
package com.sauthi.gograb.view;
...
public class AlertDialog extends Dialog {
    ...
    TextView okButton = null, cancelButton = null, neutralButton = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        okButton = (TextView) findViewById(R.id.alert_custom_dialog_okButton);
        cancelButton = (TextView) findViewById(R.id.alert_custom_dialog_cancelButton);
        neutralButton = (TextView) findViewById(R.id.alert_custom_dialog_neutralButton);
