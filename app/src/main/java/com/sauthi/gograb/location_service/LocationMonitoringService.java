package com.sauthi.gograb.location_service;
...
import com.sauthi.gograb.services.model.LatlongModel;
...
public class LocationMonitoringService extends Service implements
    ...
    private void sendLatLongToServer(final Context context, String lat, String lng) {
        ...
        addressModel.setLatitude(GlobalFunctions.getDoubleValue(latitude));
        addressModel.setLongitude(GlobalFunctions.getDoubleValue(longitude));
